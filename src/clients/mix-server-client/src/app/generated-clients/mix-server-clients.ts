...
export interface ISessionClient {
    ...
    history(startIndex?: number | undefined, endIndex?: number | undefined): Observable<GetUsersSessionsResponse>;
...
export class SessionClient implements ISessionClient {
    ...
    history(startIndex?: number | undefined, endIndex?: number | undefined): Observable<GetUsersSessionsResponse> {
        ...
        if (startIndex === null)
            ...
            url_ += "StartIndex=" + encodeURIComponent("" + startIndex) + "&";
        if (endIndex === null)
            throw new Error("The parameter 'endIndex' cannot be null.");
