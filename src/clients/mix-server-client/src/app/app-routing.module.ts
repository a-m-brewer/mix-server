...
import {TracklistPageComponent} from "./tracklist-page/tracklist-page.component";
...
const routes: Routes = [
  ...
  {path: PageRoutes.Tracklist, component: TracklistPageComponent, canActivate: [canActivate]},
