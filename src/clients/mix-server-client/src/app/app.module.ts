...
@NgModule({
  ...
  bootstrap: [AppComponent],
    imports: [BrowserModule,
        ...
        SessionComponent,
        AudioProgressSliderComponent,
        AudioControlButtonsComponent, NodeListItemTitleDirective, NodeListItemSubtitleDirective, InstanceOfPipe, FileMetadataSubtitleComponent, CopyNodeComponent, CutNodeComponent, DeleteNodeComponent, RequestTranscodeButtonComponent, IndexFolderButtonComponent],
  providers: [
    {
