...
import {
  NodeListItemIcon
} from './components/nodes/node-list/node-list-item/node-list-item-icon/node-list-item-icon.component';
...
} from './components/nodes/node-list/node-list-item/context-menu/open-location-button/open-location-button.component';
import {
  AddToQueueButtonComponent
} from './components/nodes/node-list/node-list-item/context-menu/add-to-queue-button/add-to-queue-button.component';
import {
  RemoveFromQueueButtonComponent
} from './components/nodes/node-list/node-list-item/context-menu/remove-from-queue-button/remove-from-queue-button.component';
...
import {
  FileMetadataSubtitleComponent
} from "./components/nodes/node-list/node-list-item/subtitles/file-metadata-subtitle/file-metadata-subtitle.component";
import {
  CopyNodeComponent
...
import {
    IndexFolderButtonComponent
} from "./components/nodes/node-list/node-list-item/context-menu/index-folder-button/index-folder-button.component";
...
@NgModule({
  ...
  imports: [BrowserModule,
    ...
    SessionComponent,
    AudioProgressSliderComponent,
    AudioControlButtonsComponent, NodeListItemTitleDirective, NodeListItemSubtitleDirective, InstanceOfPipe, FileMetadataSubtitleComponent, CopyNodeComponent, CutNodeComponent, DeleteNodeComponent, RequestTranscodeButtonComponent, IndexFolderButtonComponent, CdkVirtualScrollViewport, CdkFixedSizeVirtualScroll, CdkVirtualForOf],
  providers: [
    {
