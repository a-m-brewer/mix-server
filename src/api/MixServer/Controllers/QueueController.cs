...
public class QueueController(
    ...
    IQueryHandler<GetCurrentQueueQuery, QueueSnapshotDto> getCurrentQueueQueryHandler,
    ...
    : ControllerBase
{
    ...
    public async Task<IActionResult> Queue([FromQuery] GetCurrentQueueQuery query, CancellationToken cancellationToken)
    {
        return Ok(await getCurrentQueueQueryHandler.HandleAsync(query, cancellationToken));
    }
