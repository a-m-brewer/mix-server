...
namespace MixServer.Infrastructure.Migrations
{
    ...
    [Migration("20250908110728_Queueing")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MixServer.Domain.Queueing.Entities.QueueEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("CurrentFolderId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("CurrentPositionId")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("CurrentRootChildId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CurrentFolderId");

                    b.HasIndex("CurrentPositionId")
                        .IsUnique();

                    b.HasIndex("CurrentRootChildId");
            ...
            modelBuilder.Entity("MixServer.Domain.Queueing.Entities.QueueItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MixServer.Domain.Queueing.Entities.QueueEntity", b =>
                {
                    b.HasOne("MixServer.Domain.FileExplorer.Entities.FileExplorerFolderNodeEntity", "CurrentFolder")
                        .WithMany()
                        .HasForeignKey("CurrentFolderId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MixServer.Domain.Queueing.Entities.QueueItemEntity", "CurrentPosition")
                        .WithOne()
                        .HasForeignKey("MixServer.Domain.Queueing.Entities.QueueEntity", "CurrentPositionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MixServer.Domain.FileExplorer.Entities.FileExplorerFolderNodeEntity", "CurrentRootChild")
                        .WithMany()
                        .HasForeignKey("CurrentRootChildId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MixServer.Infrastructure.EF.Entities.DbUser", null)
                        .WithOne("Queue")
                        .HasForeignKey("MixServer.Domain.Queueing.Entities.QueueEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("CurrentRootChild");
                });

            modelBuilder.Entity("MixServer.Domain.Queueing.Entities.QueueItemEntity", b =>
                {
                    b.HasOne("MixServer.Domain.FileExplorer.Entities.FileExplorerFileNodeEntity", "File")
                        .WithMany()
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MixServer.Domain.Queueing.Entities.QueueItemEntity", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MixServer.Domain.Queueing.Entities.QueueEntity", "Queue")
                        .WithMany("Items")
