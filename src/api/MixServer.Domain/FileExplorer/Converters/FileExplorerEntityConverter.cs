...
{
    FileExplorerRootChildNodeEntity CreateRootChildEntityAsync(DirectoryInfo directoryInfo);
}

public class FileExplorerEntityConverter(IFileSystemHashService fileSystemHashService) : IFileExplorerEntityConverter
{
    public FileExplorerRootChildNodeEntity CreateRootChildEntityAsync(DirectoryInfo directoryInfo)
    {
